Feature: About page tells the Camp Explorer story
  ...
  Scenario: English about page renders the brand statement and all sections
    ...
    And I see a section titled "redefine how people learn"
    And I see a section titled "Real experiences create real growth"
    And I see a section titled "Abdul Explorer"
